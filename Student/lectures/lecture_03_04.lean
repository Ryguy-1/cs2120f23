...
/-
  Ryland: identity functions -> return the original value
-/
...
#eval id_bool true
#eval id_nat 102938475
#eval id_string "string wow wow wow wow wwwwww ............ efioejwi efjiejfjfj"
...
def other_poly : arg -> arg
| b => b

def id_poly_2 (α : Type) : α -> α
| α => α 


#eval id_poly String "hello"
#eval id_poly Bool (id_bool (and true false))

#eval other_poly 394

/-
  Ryland -> BIG NOTE:
    - Arrow left associative
...
#eval id_poly' Bool true  -- cannot give explicit argument when inferred!
#eval @id_poly' Bool true -- BUT, @ allows specify explicit arguments!

/-
  Ryland: looks like you can take types of many types
    - appears to the user as if it is truly polymorphic
-/
...
/-
  Ryland: apply the function to the second argument twice
-/
...
#eval apply2_nat square 2 --16
#eval apply2_nat square 1 --1
...
#eval apply2 double 5
#eval (apply2 double) 5
#check apply2 double -- "double composed with double" = double ∘ double
-- Ryland: double composed with double
