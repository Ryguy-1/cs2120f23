...
### Product Types - All of the types!
...
### Sum Types - Any combination of the types or none!
...
-- can check namespace first manually
#check Object.rock

-- open namespace, then access
open Object
#check rock
...
#eval play rock scissors -- eval only when using stock types
#reduce play rock scissors -- when you define your own types
...
-- Type of Box Nat = Type
#check Box Nat
-- Type of Box Bool = Type
-- Type of Box String = Type

def box_containing_zero : Box Nat := Box.put 3
#check box_containing_zero -- Box Nat

def box_containing_hello : Box String := Box.put "Hello"
#check box_containing_hello
def box_containing_hello' := Box.put "Hello"

#check Box -- Type -> Type
#check Box.put
#check (@Box.put) -- STUDY THIS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

-- A constructor of a polymorphic type is itself polymorphic
